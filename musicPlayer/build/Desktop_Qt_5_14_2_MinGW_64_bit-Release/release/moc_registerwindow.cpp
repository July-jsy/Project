...
QT_MOC_LITERAL(1, 15, 16), // "sendRegisterInfo"
QT_MOC_LITERAL(2, 32, 0), // ""
QT_MOC_LITERAL(3, 33, 4), // "name"
QT_MOC_LITERAL(4, 38, 4), // "pass"
QT_MOC_LITERAL(5, 43, 22) // "slot_recv_registerInfo"

    },
    "registerwindow\0sendRegisterInfo\0\0name\0"
    "pass\0slot_recv_registerInfo"
};
...
void registerwindow::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        Q_UNUSED(_t)
        switch (_id) {
        case 0: _t->sendRegisterInfo((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        case 1: _t->slot_recv_registerInfo((*reinterpret_cast< QString(*)>(_a[1])),(*reinterpret_cast< QString(*)>(_a[2]))); break;
        default: ;
        }
        ...
        int *result = reinterpret_cast<int *>(_a[0]);
        {
            ...
            if (*reinterpret_cast<_t *>(_a[1]) == static_cast<_t>(&registerwindow::sendRegisterInfo)) {
                *result = 0;
                return;
            }
        }
...
// SIGNAL 0
void registerwindow::sendRegisterInfo(QString _t1, QString _t2)
{
